"""
Оцінка AI агента для оператора автопарку автономних авто.
...
def get_agent_response(tc: dict) -> str:
    ...
    prompt = f"""Ти - AI асистент ВИКЛЮЧНО для оператора моніторингу автопарку автономних авто.
...
Оціни відповідь AI асистента для оператора автопарку за трьома критеріями від 1 до 5.
